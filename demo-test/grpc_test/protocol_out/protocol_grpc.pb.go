...
func (c *helloServiceClient) LotsOfReplies(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (HelloService_LotsOfRepliesClient, error) {
	stream, err := c.cc.NewStream(ctx, &HelloService_ServiceDesc.Streams[0], "/protocol.HelloService/LotsOfReplies", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *helloServiceLotsOfRepliesClient) Recv() (*HelloResponseStream, error) {
...
func (x *helloServiceLotsOfRepliesServer) Send(m *HelloResponseStream) error {
